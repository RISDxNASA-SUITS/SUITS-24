...
function Map() {
  ...
  useEffect(()=>{
    ...
    console.log(vLineWidth.current);
    console.log(wLineWidth.current);
    console.log(bottom.current);
    setGeoMapMarkers([
      <img src={GeoPinA} alt={"get a location pin"} className={`absolute h-20 w-12] hover:-translate-y-1 hover:scale-[1.15]`} style={{left:5.85*vLineWidth.current, bottom:7.5*wLineWidth.current}} />,
      <img src={GeoPinB} alt={"geo b location pin"} className={'absolute h-20 w-12 hover:-translate-y-1 hover:scale-[1.15]'} style={{left:9.9*vLineWidth.current, bottom:9.5*wLineWidth.current}}/>,
      <img src={GeoPinC} alt={"geo c location pin"} className={'absolute h-20 w-12 bottom-[17.15rem] left-[11.26rem] hover:-translate-y-1 hover:scale-[1.15]'} style={{left:7.9*vLineWidth.current, bottom:10.65*wLineWidth.current}} />,
      <img src={GeoPinD} alt={"geo d location pin"} className={'absolute h-20 w-12 bottom-[20.43rem] left-[14.48rem] hover:-translate-y-1 hover:scale-[1.15]'} style={{left:9.9*vLineWidth.current, bottom:12.6*wLineWidth.current}}/>,
      <img src={GeoPinE} alt={"geo e location pin"} className={'absolute h-20 w-12 bottom-[18.8rem] left-[21.06rem] hover:-translate-y-1 hover:scale-[1.15]'} style={{left:14.9*vLineWidth.current, bottom:11.6*wLineWidth.current}}/>,
      <img src={GeoPinF} alt={"geo f location pin"} className={'absolute h-20 w-12 bottom-[25.35rem] left-[29.25rem] hover:-translate-y-1 hover:scale-[1.15]'} style={{left:18.9*vLineWidth.current, bottom:15.6*wLineWidth.current}}/>,
      <img src={GeoPinG} alt={"geo g location pin"} className={'absolute h-20 w-12 bottom-[25.35rem] left-[21.06rem] hover:-translate-y-1 hover:scale-[1.15]'} style={{left:14.9*vLineWidth.current, bottom:15.6*wLineWidth.current}}/>,
      <img src={UiaPin} alt={"Uia pin location"} className={'absolute h-20 w-16 bottom-[8.85rem] left-[22.25rem] hover:-translate-y-1 hover:scale-[1.15]'} style={{left:15.6*vLineWidth.current, bottom:6.5*wLineWidth.current}}/>,
      <img src={CommPin} alt={"Comm pin location"} className={'absolute h-20 w-20 bottom-[23.7rem] left-[31.5rem] hover:-translate-y-1 hover:scale-[1.15]'} style={{left:19.25*vLineWidth.current, bottom:13.7*wLineWidth.current}}/>
    ])
